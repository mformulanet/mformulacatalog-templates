...
/*		if (defined('ENABLE_LIVEHELP') && ENABLE_LIVEHELP == 'true') {
		...
		echo '<td class="text_footer_info_pages" align="left" style="line-height: 1.2; font-weight:bold;">' . PHONE_CALL . '</td>';
		echo '</tr>';
		echo '</table>';
		}
		}
		...
		echo '<td class="text_footer_info_pages" align="left"><a href="msnim:add?contact='.MSN.'" class="text_footer_info_pages">' . MSN . '</a></td>';
		echo '</tr>';
		echo '</table>';
		}
		// MSN eof
		...
		echo '<td class="text_footer_info_pages" align="left"><a href="skype:'.SKYPE.'?add" class="text_footer_info_pages">' . SKYPE . '</a></td>';
		echo '</tr>';
		echo '</table>';
		}
		// Skype eof
