...
onmouseout="document.getElementById(\'div_name'.$specials['products_id'].'\').style.display=\'none\';">'.$add_categories_subcategories.'<span class="pl_expire_date">'.$specials_expiredate.'</span>'.$products_image_list.$add_likes_box.'<br>'.$button_youtube.'<a href="' . tep_href_link(FILENAME_PRODUCT_INFO, 'products_id=' . $specials['products_id']) . '" itemprop="url">'.$manufacturers_name.$products_model . '<span class="pl_product_name">' . $specials['products_name'] . '</span></a>'.$unidade_venda.'<br>'.$button_buynow.'</div></td>' . "\n";
