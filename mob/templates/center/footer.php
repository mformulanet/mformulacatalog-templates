...
/*		if (ENABLE_LIVEHELP == 'true') {
		...
		echo '<td class="main" align="left" style="line-height: 1.2; font-weight:bold;">' . PHONE_CALL . '</td>';
		echo '</tr>';
		echo '</table>';
		}
		...
		echo '<td class="main" align="left"><a href="msnim:add?contact='.MSN.'">' . MSN . '</a></td>';
		echo '</tr>';
		echo '</table>';
		}
		// MSN eof
		...
		echo '<td class="main" align="left"><a href="skype:'.SKYPE.'?add">' . SKYPE . '</a></td>';
		echo '</tr>';
		echo '</table>';
		}
		// Skype eof
