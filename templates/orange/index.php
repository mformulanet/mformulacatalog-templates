...
<?php
}elseif (defined('USE_INDEX_BANNERSORNPORS') && USE_INDEX_BANNERSORNPORS == "BannersEffects5") {
?>
	  <tr>
	    <td align="center"><?php require(DIR_WS_BOXES . 'column_banner_index5.php'); ?></td>
	  </tr>
<?php
...
?>
<?php
if (defined('MANUFACTURERS_BANNER_POSITION') && MANUFACTURERS_BANNER_POSITION == 'Index_Top') {  
?>
    <tr>
   ...
   <tr>
     <td>
		<div id="horizontalTab">
			...
			<div id="tab-1">
			<?php 
			if (ENABLE_XMLFRAMEWORK_MFORMULA == true) {
...
// DEFAULT SPECIALS START...
               if (defined('SHOW_DEFAULTSPECIALS') && SHOW_DEFAULTSPECIALS=="true" && defined('TAB_DEFAULT_STYLE') && TAB_DEFAULT_STYLE != "true") {
?>
   <tr>
     <td><?php echo tep_draw_separator('pixel_trans.gif', '100%', '5'); ?></td>
   </tr>
...
//		include(DIR_WS_MODULES . 'specials_products_index_xml_carousel.php');
//		}else{
//		include(DIR_WS_MODULES . 'specials_products_index_xml.php');
//		}
//	 }else{
	 	if (defined('CAROUSEL_DEFAULT') && CAROUSEL_DEFAULT == 'true') {
		include(DIR_WS_MODULES . 'default_specials_carousel.php');
...
<?php
if( defined('FEATURED_PRODUCTS_DISPLAY') AND FEATURED_PRODUCTS_DISPLAY == 'true'  && TAB_DEFAULT_STYLE != "true") {
?>
    <tr>
    	<td><?php echo tep_draw_separator('pixel_trans.gif', '100%', '10'); ?></td>
    </tr>
...
//            include(DIR_WS_MODULES . 'featured_products_index_xml_carousel.php');
//            }else{
//            include(DIR_WS_MODULES . 'featured_products_index_xml.php');
//            }
//        }else{
            if (defined('CAROUSEL_DEFAULT') && CAROUSEL_DEFAULT == 'true') {
            include(DIR_WS_MODULES . 'featured_carousel.php');
...
?>
<?php
if (defined('MANUFACTURERS_BANNER_POSITION') && MANUFACTURERS_BANNER_POSITION == 'Index_Middle') {  
?>
    <tr>
        <td><?php echo tep_draw_separator('pixel_trans.gif', '100%', '10'); ?></td>
    </tr>
...
?>
<?php
if (defined('DISPLAY_NEWS_PRODUCTS_INDEX') && DISPLAY_NEWS_PRODUCTS_INDEX == 'show' && defined('TAB_DEFAULT_STYLE') && TAB_DEFAULT_STYLE != "true") {  
?>
    <tr>
        <td><?php echo tep_draw_separator('pixel_trans.gif', '100%', '10'); ?></td>
    </tr>
...
//            include(DIR_WS_MODULES . 'new_products_index_xml_carousel.php');
//            }else{
//            include(DIR_WS_MODULES . 'new_products_index_xml.php');
//            }
//        }else{
            if (defined('CAROUSEL_DEFAULT') && CAROUSEL_DEFAULT == 'true') {
            include(DIR_WS_MODULES . 'new_products_carousel.php');
...
?>
<?php
if (defined('DISPLAY_BESTSELLERS_INDEX') && DISPLAY_BESTSELLERS_INDEX == 'show' && defined('TAB_DEFAULT_STYLE') && TAB_DEFAULT_STYLE != "true") {  
?>
    <tr>
        <td><?php echo tep_draw_separator('pixel_trans.gif', '100%', '10'); ?></td>
    </tr>
...
?>
    ...
    ?>
<?php
if (defined('MANUFACTURERS_BANNER_POSITION') && MANUFACTURERS_BANNER_POSITION == 'Index_Bottom') {  
?>
    <tr>
        <td><?php echo tep_draw_separator('pixel_trans.gif', '100%', '10'); ?></td>
    </tr>
