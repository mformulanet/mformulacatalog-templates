...
$add_ce = '</div>';
	  ...
	  $info_box_contents[$row][$col] = array('align' => 'center',
                                          ...
                                          'text' => '<div class="pl_style_border_div">
										   ...
										   <tr>
										   <td width="30%" align="center" style="padding-right:10px;">
										   <a href="' . tep_href_link(FILENAME_PRODUCT_INFO, 'products_id=' . $products_id) . '" itemprop="url">' . tep_image(DIR_WS_IMAGES . $products_image, $products_name, SMALL_IMAGE_WIDTH, SMALL_IMAGE_HEIGHT) . '</a>
										   </td>
										   <td valign="default" width="50%" class="smallText">
										   ...
										   <br><a href="' . tep_href_link(FILENAME_PRODUCT_INFO, 'products_id=' . $products_id) . '" itemprop="url">' . $manufacturers_name . $products_model. '<span class="pl_product_name">'.$products_name . '</span></a>'.$unidade_venda.'<br>'.$whats_new_price.'
...
if (PRODUCT_LIST_ONMOUSEOVER_BUTTONS == "true") {
	$add_button_buynow = '<div class="div_hidden" id="div_name'.$products_id.'"><br>'.$button_buynow.'</div>';
}else{
	$add_button_buynow = '<br>'.$button_buynow;
}
...
onmouseout="document.getElementById(\'div_name'.$products_id.'\').style.display=\'none\';">'.$add_categories_subcategories.$products_image_list.$add_likes_box.''.$button_free_shipping.'<br><br>'.$button_youtube.'<a href="' . tep_href_link(FILENAME_PRODUCT_INFO, 'products_id=' . $products_id) . '" itemprop="url">' . $manufacturers_name . $products_model.'<span class="pl_product_name">'.$products_name . '</span></a>'.$unidade_venda.'<br>'.$whats_new_price.'<span class="pl_expire_date">'.$specials_expiredate.'</span>'.$add_button_buynow.'</div></span>'.$add_ce;
...
if (PRODUCT_LIST_ONMOUSEOVER_BUTTONS == "true") {
	...
	$add_button_buynow = '<br>'.$button_buynow;
	  ...
	  $info_box_contents[$row][$col] = array('align' => 'left',
                                          ...
                                          'text' => '<div class="pl_style_border_div">'.$add_categories_subcategories.$products_image_list.$add_likes_box.''.$button_free_shipping.'<br><br>'.$button_youtube.'<a href="' . tep_href_link(FILENAME_PRODUCT_INFO, 'products_id=' . $products_id) . '" itemprop="url">' . $manufacturers_name . $products_model.'<span class="pl_product_name">'.$products_name . '</span></a>'.$unidade_venda.'<br>'.$whats_new_price.'<span class="pl_expire_date">'.$specials_expiredate.'</span>'.$button_buynow.'</div>');
