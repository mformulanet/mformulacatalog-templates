...
// likes eof
	    ...
	    <tr>
		  ...
		  echo '<span class="pl_expire_date">' . $specials_expiredate . '</span>';
		  }
		  if (!empty($manufacturers_name)) {
		  echo $manufacturers_name."<br>";
		  }
		  echo $button_youtube;
		  echo $products_model . '<a href="' . tep_href_link(FILENAME_PRODUCT_INFO, 'products_id=' . $random_product['products_id']) . '"><span class="pl_product_name">' .$random_product['products_name'] . '</span></a>'.$unidade_venda.'</td>';
		  echo '
...
if (PRODUCT_LIST_ONMOUSEOVER_BUTTONS == "true") {
	...
	$add_button_buynow = '<br>'.$button_buynow;
		  ...
		  echo '<td width="25%" class="smallText" valign="top"><div class="pl_style_border_div" onmouseover="document.getElementById(\'div_name'.$random_product['products_id'].'\').style.display=\'\';" 
onmouseout="document.getElementById(\'div_name'.$random_product['products_id'].'\').style.display=\'none\';">'.$add_categories_subcategories.$products_image_list.$add_likes_box.'<br>'.$button_youtube.'<a href="' . tep_href_link(FILENAME_PRODUCT_INFO, 'products_id=' . $random_product['products_id']) . '">'.(!empty($manufacturers_name) ? $manufacturers_name.'<br>' : '').$products_model . '<span class="pl_product_name">' .$random_product['products_name'] . '</span></a>'.$unidade_venda.'<br><span class="pl_expire_date">' . $specials_expiredate . '</span>'.$add_button_buynow.'</div></td>' . "\n";
