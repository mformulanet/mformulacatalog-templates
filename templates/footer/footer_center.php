...
?>
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="bkgfooter">
  <tr>
    <td align="center"><table width="95%" border="0" align="center" cellpadding="0" cellspacing="5">
      ...
      <table width="95%" border="0" align="center" cellpadding="0" cellspacing="5">
        <tr>
          <td class="smallText" valign="top"><table border="0" align="center" cellpadding="0" cellspacing="5">
            <tr>
              <td valign="top" class="smallText"><?php
                require(DIR_WS_BOXES . 'extra_info_pages_footer.php');
                ?></td>
              <?php
				if (ALIGN_PL_INFOPAGES_FOOTER_BOX == 'center_1column' || ALIGN_PL_INFOPAGES_FOOTER_BOX == 'left_1column') {
				?>
              </tr>
              <tr>
				<?php
        ...
        <tr>
          <td style="border-bottom:#CCCCCC solid 1px;" class="smallText" valign="top">&nbsp;</td>
        </tr>
        <tr>
          <td align="center" valign="top" class="smallText" style="border-bottom:#CCCCCC solid 1px;">&nbsp;</td>
        </tr>
        <tr>
          <td align="center" valign="top" class="smallText"><?php
		// live help
/*		if (defined('ENABLE_LIVEHELP') && ENABLE_LIVEHELP == 'true') {
        ...
        <tr>
          <td align="center" valign="top" class="smallText"><table border="0" cellspacing="5" cellpadding="0">
            <tr>
              <td align="center"><?php 
